#' Function to multiply impute missing variable entries of an incomplete categorical variable using 
...
fn_popcal_mi_cat <- function(data, missing_covariate, true_distribution, true_distribution_n = NULL, m=50){
imp <- list(NULL)
